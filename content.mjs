...
export const content = {
  ...
  en: {
    ...
    disclaimer: 'An independent application · not a Nous Research page',
    block: 'APPLICATION',
    cvBtn: '&#8595; Download CV (PDF)',
    clBtn: '&#8595; Cover letter (PDF)',
  ...
  es: {
    ...
    disclaimer: 'Candidatura independiente · no es una página de Nous Research',
    block: 'CANDIDATURA',
    cvBtn: '&#8595; Descargar el CV (PDF)',
    clBtn: '&#8595; Carta de presentación (PDF)',
  ...
  zh: {
    ...
    disclaimer: '独立求职页面 · 并非 Nous Research 官方页面',
    block: '自荐信',
    cvBtn: '&#8595; 下载简历（PDF）',
    clBtn: '&#8595; 求职信（PDF）',
